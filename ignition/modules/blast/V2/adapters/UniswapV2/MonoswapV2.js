...
module.exports = buildModule("MonoswapV2Adapter__SSV2", (m) => {
  const { gasRefund } = m.useModule(gasRefundModule);

  const monoswapV2Adapter__SSV2 = m.contract(
    "UniswapV2AdapterV2",
  ...
  m.call(monoswapV2Adapter__SSV2, "initialize", [gasRefund], { after: [monoswapV2Adapter__SSV2] });

  return { monoswapV2Adapter__SSV2 };
});
