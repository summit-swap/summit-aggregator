...
const MonoswapV2__SSV2_2_Module = require("./adapters/UniswapV2/MonoswapV2__2");

module.exports = buildModule("RouterAdapters__SSV2_BF1", (m) => {
  ...
  const { monoswapV2Adapter__SSV2__2 } = m.useModule(MonoswapV2__SSV2_2_Module);
