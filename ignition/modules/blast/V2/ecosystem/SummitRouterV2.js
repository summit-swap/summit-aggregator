...
module.exports = buildModule("SummitRouterV2__SSV2", (m) => {
  const deployer = m.getAccount(0);
  const { gasRefund } = m.useModule(gasRefundModule);

  const summitRouterV2__SSV2 = m.contract("SummitRouterV2", [[], hopTokens, deployer, wNative], {
    after: [gasRefund],
  });

  m.call(summitRouterV2__SSV2, "initialize", [gasRefund], { after: [gasRefund, summitRouterV2__SSV2] });
