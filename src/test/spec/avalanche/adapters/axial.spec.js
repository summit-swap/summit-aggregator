...
describe("SummitAdapter - Axial", () => {
  ...
  describe("AM3D", () => {
    before(async () => {
      ...
      const adapterArgs = ["AxialAM3DAdapter", curvelikePools.AxialAM3D, 320_000];
  ...
  describe("AS4D", () => {
    before(async () => {
      const contractName = "SaddleAdapter";
      const adapterArgs = ["AxialAS4DAdapter", curvelikePools.AxialAS4D, 330_000];
      ate = await testEnv.setAdapterEnv(contractName, adapterArgs);
    });
