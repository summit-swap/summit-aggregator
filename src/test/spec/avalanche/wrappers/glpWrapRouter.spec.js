...
describe("GLP Wrap Router", () => {
  ...
  before(async () => {
    ...
    const summitRouter = "0xC4729E56b831d74bBc18797e0e17A295fA77488c";
    const routerArgs = [summitRouter];
    wrapRouter = await deployContract("SummitWrapRouter", { args: routerArgs, deployer: testEnv.deployer });
    ...
    const router = await ethers.getContractAt("src/contracts/SummitRouter.sol:SummitRouter", summitRouter);
