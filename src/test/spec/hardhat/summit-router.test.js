...
describe.only("SummitRouter", function () {
  ...
  async function deployFixture() {
    ...
    await summitRouter.setTokenVolumeMultipliers([TOKEN_A.target, TOKEN_B.target], [eN(50, 12), eN(1, 12)]);
  ...
  it("Can do a swap", async () => {
    const { router, dummyAdapter, deployer, TOKEN_A, TOKEN_B, FEE_CLAIMER } = await loadFixture(deployFixture);
