...
import { IERC20, SafeERC20, UniswapV3likeAdapterV2, IUniV3Pool } from "./UniswapV3likeAdapterV2.sol";
...
contract UniswapV3AdapterBaseV2 is UniswapV3likeAdapterV2 {
    ...
    ) UniswapV3likeAdapterV2(_name, _swapGasEstimate, _quoter, _quoterGasLimit) {
        FACTORY = _factory;
